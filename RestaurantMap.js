...
const RestaurantMap = (props) => {
  ...
  const categoryOptions = ['한식', '중식', '일식', '양식', '분식'];
  ...
  return (
    <View style={[styles.container, { backgroundColor: currentColors.background }]}>
        ...
        {selectedRestaurant && (
          <View style={[styles.selectedRestaurantCard, { backgroundColor: currentColors.surface, shadowColor: currentColors.primary }]}>
            ...
            <View style={styles.selectedCardDetails}>
              ...
              <Text style={[styles.selectedDistanceText, { color: currentColors.deepBlue }]}>
                {selectedRestaurant.distance < 1 ? `${(selectedRestaurant.distance * 1000).toFixed(0)}m` : `${selectedRestaurant.distance.toFixed(1)}km`}
              </Text>
            </View>
            <TouchableOpacity
      ...
      <Animated.View style={[styles.listSection, { height: listHeightAnim, backgroundColor: currentColors.surface, shadowColor: currentColors.primary }]}> 
        ...
        <ScrollView style={[styles.listContainer, { backgroundColor: currentColors.surface }]} showsVerticalScrollIndicator={false}>
                      {filteredAndSortedRestaurants.map((restaurant) => (
