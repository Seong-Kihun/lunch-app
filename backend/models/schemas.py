...
class ErrorResponse(BaseModel):
    ...
    details: str | None = Field(None, description="상세 에러 정보")
...
class PersonalScheduleBase(BaseModel):
    ...
    recurrence_type: str | None = Field(None, description="반복 유형 (daily, weekly, monthly)")
    recurrence_interval: int | None = Field(None, ge=1, description="반복 간격")
    recurrence_end_date: date | None = Field(None, description="반복 종료 날짜")
...
class PersonalScheduleUpdate(BaseModel):
    """개인 일정 수정 요청 모델"""
    title: str | None = Field(None, min_length=1, max_length=100, description="일정 제목")
    schedule_date: date | None = Field(None, description="일정 날짜")
    is_recurring: bool | None = Field(None, description="반복 일정 여부")
    recurrence_type: str | None = Field(None, description="반복 유형")
    recurrence_interval: int | None = Field(None, ge=1, description="반복 간격")
    recurrence_end_date: date | None = Field(None, description="반복 종료 날짜")
...
class PersonalScheduleResponse(PersonalScheduleBase):
    ...
    employee_id: str = Field(..., description="직원 ID")
    original_schedule_id: int | None = Field(None, description="원본 일정 ID")
...
class PartyBase(BaseModel):
    ...
    description: str | None = Field(None, max_length=500, description="파티 설명")
    max_members: int | None = Field(None, ge=1, description="최대 멤버 수")
...
class PartyUpdate(BaseModel):
    """파티 수정 요청 모델"""
    name: str | None = Field(None, min_length=1, max_length=100, description="파티 이름")
    description: str | None = Field(None, max_length=500, description="파티 설명")
    tags: str | None = Field(None, description="파티 태그")
    category: str | None = Field(None, description="파티 카테고리")
...
class VoteBase(BaseModel):
    ...
    description: str | None = Field(None, max_length=500, description="투표 설명")
