...
from backend.application.unit_of_work import (
    ...
    TransactionAlreadyCommittedError, TransactionAlreadyRolledBackError
)
...
class SQLUnitOfWork(UnitOfWorkBase):
    ...
    def __init__(self, transaction_manager: Optional[SQLTransactionManager] = None):
        if transaction_manager is None:
            transaction_manager = SQLTransactionManager()
        
        super().__init__(transaction_manager)
        self._transaction_manager: SQLTransactionManager = transaction_manager
        self._parties: Optional[PartyRepository] = None
        self._users: Optional[UserRepository] = None
        self._party_members: Optional[PartyMemberRepository] = None
